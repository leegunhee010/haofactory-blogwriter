...
[표·차트 — 선택. 한눈에 보면 정말 도움되는 정보가 있을 때만(비교/단계/비율/추이 등). 억지로 넣지 말 것]
...
- 제목에 메인키워드를 포함한다. 분량은 공백 제외 1,500~2,000자(★2,000자를 절대 넘기지 말 것 — 넘칠 것 같으면 덜 중요한 문장·군더더기·중복 설명을 덜어낸다). 메인키워드를 제목·소제목·본문에 자연스럽게 5~8회 녹인다(억지 반복 금지).
...
- ★분량이 공백 제외 1,500~2,000자 범위인가(2,000자를 넘지 않았는가 — 넘으면 군더더기를 덜어낸다).
